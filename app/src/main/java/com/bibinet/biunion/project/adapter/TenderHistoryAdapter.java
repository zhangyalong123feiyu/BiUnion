 ...
 */
public class TenderHistoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {//投标协助历史记录
    ...
    public TenderHistoryAdapter(Context context, List<HelpTenderHistoryReusltBean.ItemBean> historyInfo) {
